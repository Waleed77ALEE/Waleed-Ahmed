...
export const TermsPage: React.FC = () => {
  ...
  const schemaJson = {
    ...
    name: 'Terms of Service | WALEEDKHANAFRIDI.ONLINE by Waleed Khan Afridi',
    description: 'Master Terms of Service governing WALEEDKHANAFRIDI.ONLINE digital marketplace, software licenses, AI subscriptions, and payment services operated by Waleed Khan Afridi Digital Agency (waleedkhanafridi.online/tos).',
    publisher: {
      '@type': 'Organization',
  ...
  return (
    <LegalLayout
      ...
      subtitle="Master Service Agreement, Digital Goods License Terms, and Acceptable Use Policy for WALEEDKHANAFRIDI.ONLINE by Waleed Khan Afridi Digital Agency (waleedkhanafridi.online/tos)."
