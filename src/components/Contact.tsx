    ...
    <div className="py-20 bg-slate-900/60 relative border-t border-slate-800 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 mb-20">
          ...
          >
            {/* Local Office Business Identity Card */}
            <div className="bg-slate-950 border border-slate-800 rounded-2xl p-6 shadow-xl space-y-4">
              <div className="flex items-center gap-2 text-cyan-400 font-bold text-xs uppercase tracking-wider">
                <Globe className="w-4 h-4" />
                <span>Agency Headquarters &amp; Local Office</span>
              </div>
              ...
              <div className="space-y-3 text-xs">
                <div className="flex items-start gap-3 p-3 rounded-xl bg-slate-900/80 border border-slate-800">
                  ...
                  <div>
                    <span className="block text-[11px] text-slate-400">Official Direct Line &amp; WhatsApp:</span>
                    <strong className="text-white text-sm font-mono">+92 341 6860077</strong>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 p-3 rounded-xl bg-slate-900/80 border border-slate-800">
                  ...
                  <div className="flex-1 min-w-0">
                    <span className="block text-[11px] text-slate-400">Official Professional Email:</span>
                    <strong className="text-cyan-300 font-mono text-xs truncate block">{officialEmail}</strong>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 p-3 rounded-xl bg-slate-900/80 border border-slate-800">
                  ...
                  <div>
                    <span className="block text-[11px] text-slate-400">Business Support Hours:</span>
                    <strong className="text-slate-200">Mon – Sat: 09:00 AM – 10:00 PM (PKT / UTC+5)</strong>
                    <span className="block text-[10px] text-emerald-400 font-semibold mt-0.5">24/7 Digital Account Fulfillment</span>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 p-3 rounded-xl bg-slate-900/80 border border-slate-800">
                  ...
                  <div>
                    <span className="block text-[11px] text-slate-400">Physical Office &amp; Business Address:</span>
                    <strong className="text-slate-100 leading-tight block">Office 4B, Sector F-11 Markaz, Islamabad, 44000, Pakistan</strong>
                  </div>
                </div>
              </div>
              ...
              <a
                ...
                className="w-full py-3 px-4 rounded-xl text-xs font-bold text-slate-950 bg-gradient-to-r from-emerald-400 to-teal-400 hover:from-emerald-300 hover:to-teal-300 shadow-xl shadow-emerald-500/20 transition-all flex items-center justify-center gap-2"
              >
                <MessageSquare className="w-4 h-4 fill-slate-950" />
                <span>Instant WhatsApp Direct Order &amp; Chat</span>
              </a>
            </div>
