          ...
          <div className="p-5 sm:p-6 space-y-6 overflow-y-auto max-h-[75vh]">
            {placedOrder ? (
              ...
              <form onSubmit={handleSubmitOrder} className="space-y-5">
                ...
                <div className="flex items-start sm:items-center gap-3 p-3.5 rounded-xl bg-blue-500/10 border border-blue-500/30 text-blue-400 shadow-md shadow-blue-500/5">
                  <div className="p-2 rounded-lg bg-white shrink-0 mt-1 sm:mt-0 shadow-sm shadow-blue-500/20">
                  ...
                  <div className="text-xs">
                    <span className="font-bold flex items-center gap-1.5 text-blue-300">
                      ...
                      Google Verified Authentic
                    </span>
                    <p className="mt-0.5 text-[11px] text-blue-200/80 leading-relaxed">
                      All accounts are checked and verified from Google to ensure 100% security, authenticity, and seamless performance.
                    </p>
                  </div>
                </div>
